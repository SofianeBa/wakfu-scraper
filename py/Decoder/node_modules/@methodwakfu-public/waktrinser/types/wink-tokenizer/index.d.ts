...
class Tokenizer {
     ...
     * @returns tokens
     */
    public tokenize(sentence: string): Tokenizer.Token[];
     ...
     */
    public defineConfig(config: Tokenizer.Config): number;
     ...
     */
    public getTokensFP(): string;

    public addRegex(regex: RegExp, tag: string, signature: string): void;
}
